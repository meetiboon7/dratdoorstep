...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title>User Login | Dr at Doorstep</title>
			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				...
				<div class="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
					...
					<div class="position-absolute top-0 right-0 text-right mt-5 mb-15 mb-lg-0 flex-column-auto justify-content-center py-5 px-10">
						...
						<a href="<?php echo base_url(); ?>signUp" class="font-weight-bold ml-2" id="kt_login_signup1">Sign Up!</a>
					...
					<div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
						...
						<div class="login-form login-signin">
							...
							<?php } ?>
							<form class="form" method="post"  action="<?php echo base_url()?>dashboard" id="kt_login_signin_form1">
								...
								<div class="form-group">
									<input class="form-control" type="text" placeholder="Email / Mobile No" name="login" autocomplete="off" />
									<?php if ($error): ?>
								...
								<div class="form-group d-flex flex-wrap justify-content-between align-items-center">
									...
									<a href="<?php echo base_url(); ?>forgotPin" class="text-dark-50 text-hover-primary my-3 mr-2" id="kt_login_forgot">Forgot Pin ?</a>
								...
								<div class="form-group d-flex flex-wrap flex-center">
									<!-- <a href="<?php echo base_url();?>facebook" style="background-image: url(uploads/image/social-buttons.png);" class="connect-with-button  account-sprites-facebook" title="Facebook Connect"></a>
									<a href="<?php echo base_url()?>gmail" style="background-image: url(uploads/image/social-buttons.png);" class="connect-with-button marginleft13 account-sprites account-sprites-google" title="Google"></a> -->
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
