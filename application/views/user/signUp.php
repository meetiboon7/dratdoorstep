					...
					<div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
						...
						<form class="form" method="post" action="<?php echo base_url()?>userSignup"  id="kt_login_signup_form">
								<div class="form-group">
									<input class="form-control" type="email" placeholder="Email" name="email_address"  value=""  />
								...
								<div class="form-group">									
									<input type="text" onkeypress="return isNumber(event)" maxlength="10" maxlength="10" class="form-control isRequired" placeholder="Mobile" name="mobile" id="mobile" required>
									<div class="validation"></div>
									<div id="mobile_valid_id" class="validation" style="display:none;color:red;">Please enter correct number.</div>
								</div>
								
								<div class="form-group">									
									<input type="password" onkeypress="return isNumber(event)" maxlength="4" class="form-control" placeholder="Pin" name="password" id="password" required>
									<div class="validation"></div>
								</div>
								<div class="form-group">									
									<input type="password" onkeypress="return isNumber(event)" maxlength="4" 
									class="form-control" placeholder="Confirm Pin" name="confirm_password" id="confirm_password" required>
									<div class="validation"></div>
								</div>
								
								<div class="form-group">									
									<input type="text"  class="form-control" placeholder="Referal Code" name="referral_code" id="referral_code">
								</div>
								...
								<div class="form-group d-flex flex-wrap flex-center">
									...
									<a type="button" id="kt_login_signup_cancel" class="btn btn-light-primary font-weight-bold px-9 py-4 my-3 mx-4" href="<?php echo base_url()?>">Cancel</a>
								</div>
							</form>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#kt_login_signup_submit1").click(function () {
           var city_valid = $(".city_valid");
           
            var mobile_count = $('#mobile').val().length;
            
            
            if(mobile_count <= 10 && mobile_count >= 10)
            {
                $('#mobile_valid_id').hide();
        		
            }
            else
            {
                  $('#mobile_valid_id').show();
                   return false;
            }
