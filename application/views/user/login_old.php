...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title>Admin Login | Dr at Doorstep</title>
				...
				<div class="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
					...
					<div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
						...
						<div class="login-form login-signin">
							...
							<!--begin::Form-->
							<form class="form" method="post"  action="<?php echo base_url()?>dashboard" id="kt_login_signin_form">
								<!-- <div class="form-group">
									<input class="form-control form-control-solid h-auto py-5 px-6" type="text" placeholder="Username" name="mobile" autocomplete="off" />
								</div> -->
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-5 px-6" type="text" placeholder="Mobile" name="mobile" autocomplete="off" pattern="[1-9]{1}[0-9]{9}" onkeypress="return isNumber(event)" maxlength="10" />
									<?php if ($error): ?>
								...
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-5 px-6" type="password" placeholder="Pin" name="password" autocomplete="off" onkeypress="return isNumber(event)" maxlength="4"/>
									<?php if ($error): ?>
						...
						<div class="login-form login-signup">
							...
							<!--begin::Form-->
							<form class="form" method="post" action="<?php echo base_url()?>userSignup"  id="kt_login_signup_form">
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-5 px-6" type="email" placeholder="Email" name="email" id="email" autocomplete="off" required />
									<div class="validation"></div>
								</div>

								<div class="form-group">									
									<input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="10" class="form-control form-control-solid h-auto py-5 px-6" placeholder="Mobile" name="mobile" id="mobile" required>
									<?php if ($error): ?>
    									<div id="infoMessage"  class="text-danger"><?php echo form_error('mobile'); ?></div>
								<?php endif ?>
								</div>
								<div class="form-group">									
									<input type="text" oninput="this.value = this.value.replace(/[^0-4.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="4" class="form-control form-control-solid h-auto py-5 px-6" placeholder="Pin" name="password" id="pin" required>
								</div>
								<div class="form-group">									
									<input type="text" oninput="this.value = this.value.replace(/[^0-4.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="4" class="form-control form-control-solid h-auto py-5 px-6" placeholder="Confirm Pin" name="confirm_password" id="confirm_pin" required>
								</div>
								
								<div class="form-group">									
									<input type="text"  class="form-control form-control-solid h-auto py-5 px-6" placeholder="Referal Code" name="referral_code" id="referral_code">
								</div>
								<div class="form-group">
								...
								<div class="form-group d-flex flex-wrap flex-center">
									<button type="submit" id="kt_login_signup_submit1" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4" id="signupuser" name="signupSubmit">Submit</button>
