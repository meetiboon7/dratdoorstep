			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				...
				<div class="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
					...
					<div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
						...
						<form class="form" method="post" action="<?php echo base_url()?>ForgotPassword"  id="kt_login_forgot1">
								
								<div class="form-group">
									<input class="form-control" type="text" placeholder="Email/Mobile" name="email" id="email" value="" required />
								...
								<div class="form-group d-flex flex-wrap flex-center">
									...
									<a type="button" id="kt_login_forgot_cancel" class="btn btn-light-primary font-weight-bold px-9 py-4 my-3 mx-4" href="<?php echo base_url()?>">Cancel</a>
								</div>
						</form>
