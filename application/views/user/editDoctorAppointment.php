		...
		<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Doctor Appointment</h5>
									<!--end::Page Title-->
								</div>
								<!--end::Info-->
							</div>
										...
										<select class="form-control select2 doctor_type_validate" id="kt_select2_17" name="d_type_id" >
											...
											<?php 
												...
												foreach($doctor_type as $dt){
													...
													if($dt['d_type_id'] == $cart['doctor_type_id']){ $selected_type = "selected"; }
...
//alert(doctor_type_validate);
	if(member!="none" && address!="none" && date!="" && time!="" &&  doctor_type_validate!="none")
	{
			jQuery.ajax({
			type: "POST",
			url: "<?php echo base_url('updateDoctorCart'); ?>",
			dataType: 'html',
			data: {cart_id:cart_id,member:member,date: date, time: time,doctor_type_validate:doctor_type_validate,address:address,complain:complain},
