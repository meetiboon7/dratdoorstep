...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Error-->
			<!-- <div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30" style="background-image: url('http://localhost/DADS_Web/assets/media/bg/bg2.jpg');"> -->
				<div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30" style="background-image: url('http://localhost/DADS_Web/assets/media/bg/bg3.jpg');">
				<!--begin::Content-->
				<h1 class="font-weight-boldest text-dark-75 mt-15" style="font-size: 10rem">404</h1>
				<p class="font-size-h3 text-muted font-weight-normal" style="font-color:red;">Your Payment has been Failed</p>
				<!--end::Content-->
			</div>
			<!--end::Error-->
		</div>
