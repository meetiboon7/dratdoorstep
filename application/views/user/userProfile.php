											...
											<div class="card-body pt-4">
												...
												<div class="d-flex align-items-center">
													<div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
														<div class="symbol-label" style="background-image: url('<?php echo $profile_image ?>');"></div>
													...
													<div>
														<a href="javascript:void(0);" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary" >
															<?php //echo ucfirst($this->session->userdata('user')['first_name'])." ".ucfirst($this->session->userdata('user')['last_name']);?>
												...
												<div class="py-9">
													...
													<div class="row">
														<span class="font-weight-bold mr-2" style="margin-left:-5px;">Email  :</span>
														</div>
														<div class="row">
														<a href="#" class="text-muted text-hover-primary" style="margin-right:20px;">
															<?php echo $view_user_profile->email; ?>
														</a>
														</div>
													</div>
													<div class="d-flex align-items-center justify-content-between mb-2">
													<div class="row">
														<span class="font-weight-bold mr-2" style="margin-left:-5px;">Phone :</span>
														</div>
														<div class="row">
														<span class="text-muted" style="margin-right:90px;">
															<?php echo $view_user_profile->mobile; ?>
									...
									<div class="flex-row-fluid ml-lg-8" id="profile_data">
										...
										<div class="card card-custom card-stretch">
											...
											<!--begin::Form-->
												...
												<form class="form" id="edit_form" action="<?php echo base_url(); ?>userupdateMyProfile"  method="post" enctype="multipart/form-data">
												<!--begin::Body-->
												<div class="card-body">
													<div class="row">
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<div class="input-group input-group-lg input-group-solid">
																...
																<input class="form-control form-control-lg form-control-solid" type="text" name="mobile" readonly value="<?php echo $view_user_profile->mobile; ?>" />
															</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<div class="input-group input-group-lg input-group-solid">
																...
																<input class="form-control form-control-lg form-control-solid" type="email" name="email" readonly value="<?php echo $view_user_profile->email; ?>" />
															</div>
														</div>
													</div>
													<div class="form-group row">
									...
									<div class="flex-row-fluid ml-lg-8" id="change_password_card" style="display: none;">
										...
										<div class="card card-custom">
											...
											<!--begin::Form-->
												...
												<form class="form" action="<?php echo base_url(); ?>userresetPassword" method="POST" id="passwordForm">
												<div class="card-body">
...
<script type="text/javascript">
    ...
    return true;
					...
					?>
					<?php //if(!$this->session->has_userdata('signup_user_id') && !isset($user_signup_status)){ 
					if($this->uri->segment(2) == 'Reset')
					{	
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom card-stretch">
											...
											<form action="<?php echo base_url(); ?>resetPassword" method="POST" id="passwordForm">
											<div class="card-body col-lg-6">
												<?php if($this->session->flashdata('msg')): ?>
    													<p style="color:red;"><b><?php echo $this->session->flashdata('msg'); ?></b></p>
												<?php endif; ?>
											<div class="row">
												<label style="margin-top:13px;"><b>Old Password:</b></label>&nbsp;&nbsp;
												<div class="form-group">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="password" required placeholder="Old Password" name="oldpass" id="oldpass" >
									 <?php //echo form_error('oldpass','<p class="help-block">','</p>'); ?>

								</div>
							</div>
											<div class="row">
												<label style="margin-top:13px;"><b>New Password:</b></label>&nbsp;&nbsp;
												<div class="form-group">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="password" required placeholder="New Password" name="newpass" id="newpass" >
									 <?php //echo form_error('newpass','<p class="help-block">','</p>'); ?>
								</div>
							</div>
											<div class="row">
												<label style="margin-top:13px;"><b>Confirm Password:</b></label>&nbsp;&nbsp;
												<div class="form-group">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="password"  required placeholder="Confirm Password" name="passconf" id="passconf" >
									 <?php //echo form_error('passconf','<p class="help-block">','</p>'); ?>
								</div>
							</div>
											<div class="row">
												<input type="submit" name="submit" value="submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4">
											</div>
