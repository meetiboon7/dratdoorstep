												...
												<tr>
													...
													<td nowrap="nowrap">
														<button formaction="<?php echo base_url(); ?>editManageFees" name="btn_edit_manage_fees"value="<?php echo $fees['fees_id']; ?>"  class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">	             
															...
															<!-- <button formaction="<?php echo base_url(); ?>deleteManageFees" name="btn_delete_manage_fees" 
																value="<?php echo $fees['fees_id'];  ?>"  class="btn btn-sm btn-clean btn-icon mr-2" title="Delete Fees Details">	             
