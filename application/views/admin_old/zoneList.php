							...
							?>
												<tr>
													...
													<td nowrap="nowrap">
														...
														<!-- <button formaction="<?php echo base_url(); ?>deleteZone" name="btn_delete_zone" value="<?php echo $zone->zone_id;  ?>"  class="btn btn-sm btn-clean btn-icon mr-2" title="Delete Zone">	             
