...
<html lang="en"> 
	...
	<head>
		...
		<!-- Hotjar Tracking Code for keenthemes.com -->		<script>(function(h,o,t,j,a,r){ h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)}; h._hjSettings={hjid:1070954,hjsv:6}; a=o.getElementsByTagName('head')[0]; r=o.createElement('script');r.async=1; r.src=t+h._hjSettings.hjid+j+h._hjSettings.hjsv; a.appendChild(r); })(window,document,'https://static.hotjar.com/c/hotjar-','.js?sv=');</script>
	</head>
	<!--end::Head-->
 ...
 <div class="card-header">
  ...
  <div class="card-toolbar">
   ...
   <i class="ki ki-plus "></i> Add Appointment
   </a>
  </div>
 </div>
 <div class="card-body">
  <div id="kt_calendar"></div>
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<!-- <div class="symbol-label" style="background-image:url('<?php echo base_url(); ?>assets/media/300_21.jpg')"></div> -->
					...
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?php echo $this->session->userdata('admin_user')['email']; ?></a>
						...
						<div class="navi mt-2">
							...
							<?php
							$logOut; 
							if(isset($this->session->userdata('admin_user')['id'])){
								$logOut = base_url().'adminUserLogout'; 
							}else{
								$logOut = base_url().'adminUserLogout';  
							}
							?>
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<!--begin::Item-->
					<a href="<?php echo base_url().'adminProfile/MyProfile'?>" class="navi-item">
						<div class="navi-link">
		...
		<!-- <script src="<?php echo base_url(); ?>assets/js/dual-listbox.js"></script> -->
		...
		<script src="<?php echo base_url(); ?>assets/js/pages/basic.js"></script>
