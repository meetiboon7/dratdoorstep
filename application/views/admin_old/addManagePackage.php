						...
						<form id="add_fees_form" class="form" action="<?php echo base_url(); ?>insertManagePackage" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="form-group col-md-4">
											...
											<input type="text" class="form-control isRequired" placeholder="Service Name" name="service_name" id="service_name" required="" />
								 ...
								 <div class="row">
								 	...
								 	<div class="form-group col-md-4" >
										...
										<input type="text" class="form-control" placeholder="Fees" name="fees_name" id="fees_name" onkeypress="return isNumber(event)"/>
									...
									<input class="form-control" type="text" placeholder="Validate Month" name="validate_month" id="validate_month"  onkeypress="return isNumber(event)" maxlength="3"/>
								...
								<div class="row">
									<div class="form-group col-md-4">
										...
										<textarea class="form-control" name="description" id="description" rows="3" cols="30"></textarea>
