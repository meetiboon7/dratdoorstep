					...
					<div class="card-body p-0">
						<form id="add_package_form" class="form" action="<?php echo base_url(); ?>updateManageTeam" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="form-group col-md-4">
										<label>Zone *</label>
										<select class="form-control select2 zone_valid" id="kt_select2_16" name="zone_id" >
								 ...
								 <div class="row">
									...
									<div class="form-group col-md-8">
										...
										<select id="kt_dual_listbox_1" class="dual-listbox" multiple name="emp_id[]">
											...
											<option value="<?php echo $value['emp_id'];?>" <?php if(isset($empIdArray)) { if(in_array($value['emp_id'], $empIdArray)){ echo "selected";} } ?> ><?php echo $value['first_name'].' '.$value['last_name'];?></option>
													<?php } ?>
												</select>
											</div>
