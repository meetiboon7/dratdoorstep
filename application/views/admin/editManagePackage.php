						...
						<form id="add_package_form" class="form" action="<?php echo base_url(); ?>updateManagePackage" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="form-group col-md-4">
										...
										<select class="form-control select2 city_valid" id="kt_select2_11" name="service_id" >
											<option value="none" selected disabled hidden> Select Service </option>
											<?php 
												foreach($service as $s){
													$selected_service = "";
													if($s['user_type_id'] == $manage_package['service_id']){ $selected_service = "selected"; }
								 ...
								 <div class="row">
									...
									<div class="form-group col-md-4" >
										...
										<input type="text" class="form-control"  placeholder="Fees Name" name="fees_name" id="fees_name" value="<?php  echo $manage_package['fees_name']?>" onkeypress="return isNumberKey(event)"/>
								...
								<div class="row">
									<div class="form-group col-md-12">
										...
										<textarea class="form-control" name="description" id="editor1" ><?php  echo $manage_package['description']?></textarea>
