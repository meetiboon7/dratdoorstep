											...
											<div class="card-header card-header-tabs-line">
												...
												<div class="card-toolbar">
													<ul class="nav nav-tabs nav-bold nav-tabs-line tabs">
														...
														<li class="nav-item">
                    										<a class="nav-link" id="6" name="id" data-toggle="tab" href="#kt_tab_pane_2_3">
                    											<span class="nav-icon">
                    												<img src="<?php echo base_url()?>uploads/image/Group 1576.svg" width="24px" height="24px" fill="#000"; />
                    											</span>
