							...
							<tr>
								...
								<td nowrap="nowrap">
									...
									?>
										...
										if ($appointment['responsestatus'] != "TXN_FAILURE" && $appointment['responsestatus'] != "TXN_CANCELLED" && $appointment['responsestatus'] != "") {
										?>
											<button formaction="<?php echo base_url(); ?>adminEditNurseAppointment" name="btn_edit_appointment" value="<?php echo $appointment['book_nurse_id']; ?>" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit Appointment">
												<span class="svg-icon svg-icon-md">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<rect x="0" y="0" width="24" height="24"></rect>
									...
									?>
										...
										if ($appointment['responsestatus'] != "TXN_FAILURE" && $appointment['responsestatus'] != "TXN_CANCELLED" && $appointment['responsestatus'] != "") {
										?>
											<button formaction="<?php echo base_url(); ?>adminEditLabAppointment" name="btn_edit_appointment" value="<?php echo $appointment['book_laboratory_test_id']; ?>" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit Appointment">
												<span class="svg-icon svg-icon-md">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<rect x="0" y="0" width="24" height="24"></rect>
									...
									?>
												<!-- <a href="#" style="pointer-events: none; cursor:not-allowed;background-color: #EEEEEE;" class="btn btn-sm btn-clean btn-icon mr-2 btn-assign" data-id="<?php echo $appointment['book_medicine_id']; ?>,<?php echo "4"; ?>" title="Assign">
										...
										if ($appointment['responsestatus'] != "TXN_FAILURE" && $appointment['responsestatus'] != "TXN_CANCELLED" && $appointment['responsestatus'] != "") {
										?>
											<button formaction="<?php echo base_url(); ?>adminEditPharmacyAppointment" name="btn_edit_appointment" value="<?php echo $appointment['book_medicine_id']; ?>" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit Appointment">
												<span class="svg-icon svg-icon-md">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<rect x="0" y="0" width="24" height="24"></rect>
									...
									?>
										...
										?>
											<button formaction="<?php echo base_url(); ?>adminEditAmbulanceAppointment" name="btn_edit_appointment" value="<?php echo $appointment['book_ambulance_id']; ?>" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit Appointment">
												<span class="svg-icon svg-icon-md">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<rect x="0" y="0" width="24" height="24"></rect>
