						...
						<form id="add_fees_form" class="form" action="<?php echo base_url(); ?>insertManageTeam" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="form-group col-md-4">
										<label>City *</label>
										<select class="form-control select2 city_valid" id="kt_select2_17" name="city_id" onChange="getZone(this.value)">
									...
									<div class="form-group col-md-4">
										<label>Zone *</label>
										<select class="form-control select2 zone_valid display_select_zone" id="kt_select2_14" name="zone_id" >
								 ...
								 <div class="row">
									...
									<div class="form-group col-md-8">
								    	...
								    	<select id="kt_dual_listbox_1" class="dual-listbox emp_valid" multiple name="emp_id[]">
												<!--  <option value="none" selected disabled hidden> Employee Entry </option> -->
											<?php 
												foreach($employee_master as $em){
													echo '<option value="'.$em['emp_id'].'">('.$em['user_type_name'].") ".$em['first_name']." ".$em['last_name'].'</option>';
												}
											?>
										</select>
