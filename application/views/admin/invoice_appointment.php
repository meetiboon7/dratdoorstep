...
<td colspan="2" style="text-align: left;" > <h2>Invoice No: <?php echo $app;?></h2></td>
            ...
            <tr class="information">
                <td colspan="2">
                    <table>
                        <tr>
                          <td>
                                <lable><b>Receipt No: <?php echo $extra_invoice['extra_invoice_id'];?></b></lable><br>
                         <?php echo $extra_invoice['name'];?><br>
                                <?php //echo $extra_invoice['address'];
                                echo $address_1." ".$address_2;
                                ?><br>
                                <?php echo "Date: ".date('d-m-Y',strtotime($extra_invoice['date']));?>
                            </td>
            ...
            <tr class="item">
                <td>
                   ...
                   // echo $extra_invoice['list'];

                    if($extra_invoice['appointment_book_id']!=0)
                    {
                       //echo " Consulting Charges";
                       echo $extra_invoice['list'];
                    }
                    elseif($extra_invoice['book_nurse_id']!=0 || $extra_invoice['book_laboratory_test_id']!=0 || $extra_invoice['book_ambulance_id']!=0)
                    {
                ...
                <td>
                   <?php echo $extra_invoice['price'] ;?> Rs
                </td>
            </tr>
            ...
            <tr class="item">
                <td>
                   <?php echo $address_data[note]; ?>
                     ...
                     <td>
                        <?php echo  number_format((float)$address_data[amount], 2, '.', '');?> ₹
                     </td>
            ...
            <tr class="total">
                ...
                <td>
                   <?php //echo $extra_invoice['price'];?>
                    Total: <?php echo   number_format((float)$extra_invoice['price']+$address_data['amount'], 2, '.', '');?> ₹
                </td>
            </tr>
        </table>
