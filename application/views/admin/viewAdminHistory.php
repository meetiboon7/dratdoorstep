<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="d-flex flex-column-fluid">
		...
		<div class="container">
			...
			<div class="row">
					...
					<div class="card card-custom">
						<div class="card-body p-0">
							...
							<div class="card-body">
								...
								?>
									<label><i class="fa fa-map-marker" aria-hidden="true"></i><?php if ($visit_book_history[0]['from_address'] != '' && $visit_book_history[0]['to_address'] != '') { ?> <b>From Address : </b><?php echo $visit_book_history[0]['from_address'] ?><br><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To Address : </b><?php echo $visit_book_history[0]['to_address'];
																																																																																	} else { ?> <b>Multi Location : </b><br><?php echo $multi_location_implode;
																																																																																																							} ?></label><br>
								<?php
				...
				if (
					$visit_book_history[0]['appointment_book_id'] != '' || $visit_book_history[0]['book_nurse_id'] != '' || $visit_book_history[0]['book_laboratory_test_id'] != '' ||
						...
						<div class="card card-custom">
							<div class="card-body p-0">
								...
								<div class="card-header">
									...
									<span><b>
											<font style="font-size: 24px;">Assign Appointment</font>
										</b></span>
								...
								<div class="card-header">
									...
									<div class="checkbox-inline">
										<label class="checkbox checkbox-lg">
											...
											<b>
												<font style="font-size: 16px;">Additional Payment</font>
											</b>
										</label>
 ...
 -->
											...
											// PACKAGES
											// elseif ($visit_book_history[0]['id'] != '') {
											?>
												<!-- <input type="hidden" name="assign_appointment_id" id="assign_appointment_id" value="<?php echo $visit_book_history[0]['id']; ?>">
												<input type="hidden" name="user_type_id" id="user_type_id" value="6">
												<input type="hidden" name="user_id" id="user_id" value="<?php echo $visit_book_history[0]['user_id']; ?>">
 -->
											<?php
											// }
							...
							<div class="card card-custom">
								<div class="card-body p-0">
									...
									<div class="card-header">
										...
										<span><b>
												<font style="font-size: 24px;">Visit Notes</font>
											</b></span>
										<span style="color:green;">
											<div id="error_message" class="ajax_response"></div>
											<div id="success_message" class="ajax_response"></div>
							...
							<div class="card card-custom">
								<div class="card-body p-0">
									...
									<div class="card-header">
										...
										<span><b>
												<font style="font-size: 24px;">ECG and XRAY</font>
											</b></span>
										<span style="color:green;">
								...
								<div class="card card-custom">
									<div class="card-body p-0">
										...
										<div class="card-header">
											...
											<span><b>
													<font style="font-size: 24px;">Prescription Upload</font>
												</b></span>
											<span style="color:green;">
												<div id="error_message" class="ajax_response"></div>
												<div id="success_message" class="ajax_response"></div>
								...
								<div class="card card-custom">
									<div class="card-body p-0">
										...
										<div class="card-header">
											...
											<span><b>
													<font style="font-size: 24px;">Lab Report</font>
												</b></span>
											<span style="color:green;">
												<div id="error_message" class="ajax_response"></div>
												<div id="success_message" class="ajax_response"></div>
							...
							<div class="card card-custom">
								<div class="card-body p-0">
									...
									<div class="card-header">
										...
										<span><b>
												<font style="font-size: 24px;">Lab Notes</font>
											</b></span>
										<span style="color:green;">
											<div id="error_message" class="ajax_response"></div>
											<div id="success_message" class="ajax_response"></div>
							...
							<div class="card card-custom">
								<div class="card-body p-0">
									...
									<div class="card-header">
										...
										<span><b>
												<font style="font-size: 24px;">Prescription Notes</font>
											</b></span>
										<span style="color:green;">
											<div id="error_message" class="ajax_response"></div>
											<div id="success_message" class="ajax_response"></div>
	...
	$(document).ready(function() {
		$("#btnSubmit").click(function() {
			...
			jQuery.ajax({
				...
				dataType: 'html',
				data: {
					visit_history_text: visit_history_text,
					assign_appointment_id: assign_appointment_id
				},
	...
	$(document).ready(function() {
		$("#btnSubmitECG").click(function() {
			...
			jQuery.ajax({
				...
				dataType: 'html',
				data: {
					ecg_and_xray_text: ecg_and_xray_text,
					assign_appointment_id: assign_appointment_id
				},
				success: function(data) {
		...
		$("#addPayment").click(function() {
			...
			jQuery.ajax({
				...
				data: {
					...
					nurse_type_validate: nurse_type_validate,
					lab_test_validate: lab_test_validate,
					user_id: user_id,
