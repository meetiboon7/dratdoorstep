					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								<!--begin::Dashboard-->
								<?php
                                if($all_permission[9][add_permission] == 1) {
                                ?>
								...
								<?php
                                    ...
                                    if($all_permission[9][edit_permission] == 1) {
                                ?>
										...
										<table class="table table-separate table-head-custom table-checkable dataTable no-footer" id="kt_datatable">
											<thead>
												<tr>
													...
													<th>Status</th>
													<?php
                                                    if($all_permission[9][edit_permission] == 1 || $all_permission[9][delete_permission] == 1) {
                                            ...
                                            <?php
                                                        ...
                                                        if($all_permission[9][delete_permission] == 1) {
                                                        ?>
