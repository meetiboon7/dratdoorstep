							...
							<div class="container">
								...
								<div class="card card-custom">
									<div class="card-header flex-wrap py-5">
										...
										// echo "</pre>";
										if($all_permission[10][add_permission] == 1) {
										...
										<table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
											<thead>
												<tr>
													...
													<!-- <th>Status</th> -->
													<?php
													if($all_permission[10][edit_permission] == 1 || $all_permission[10][delete_permission] == 1) {
											...
											<tbody>
												...
												<tr>
													...
													<td nowrap="nowrap">
													<?php
													if($all_permission[10][edit_permission] == 1) {
													?>
													...
													if($all_permission[10][delete_permission] == 1) {
