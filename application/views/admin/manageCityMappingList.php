                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            ...
                            <div class="container">
                                <!--begin::Dashboard-->
                                <?php
                                if($all_permission[1][add_permission] == 1) {
                                ?>
                                    ...
                                    <form class="form" action="<?php echo base_url();?>addCityMapping" method="post">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-2">
                                                    <label>City *</label>
                                                    <select class="form-control select2 city_name_validate" name="city_id"  id="kt_select21_2"  onChange="getZone(this.value)">
                                                ...
                                                <div class="col-lg-3">
                                                    <label>Zone *</label>
                                                    <select class="form-control select2 zone_name_validate display_select_zone" name="zone_id[]"  id="kt_select2_17" multiple  >
                                ...
                                <?php
                                    ...
                                    if($all_permission[1][edit_permission] == 1) {
                                ?>
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row">
                                                 <div class="col-lg-3">
                                                    <label>Employee *</label>
                                            <div class="span_id">
                                        <select class="form-control sel_act-emp select2" id="kt_select2_16" name="emp_id" >
                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body">
                                        <!--begin: Datatable-->
                                        <form method="post">
                                        <table class="table table-separate table-head-custom table-checkable dataTable no-footer" id="citymapping">
                                            <thead>
                                                <tr>
                                                    <th>Sr No</th>
                                                    <th>Employee Name</th>
                                                    ...
                                                    <th>Status</th>
                                                    <?php
                                                    if($all_permission[1][edit_permission] == 1 || $all_permission[1][delete_permission] == 1) {
                            ...
                            ?>
                                                <tr>
                                                    ...
                                                    <!-- <td>West Zone</td> -->
                                                    <!-- <td>Inactive</td> -->
                                                    <input type="hidden" name="city_id" id="city_data_id" value="<?php echo $cityMapping->city_id;?>">
                                                    <?php
                                                    if($all_permission[1][edit_permission] == 1 || $all_permission[1][delete_permission] == 1) {
                                            ...
                                            <?php
                                                        ...
                                                        if($all_permission[1][delete_permission] == 1) {
                                                        ?>
    ...
    $(function () {
        ...
        $("#btnSubmit").click(function () {
           ...
           //   alert(zone_name_validate);
            ...
            var options = $('#kt_select2_17 > option:selected');
            //alert(options);
             if(options.length == 0){
                   $('#zone_name_id').show();
        ...
        if(city_id){
            ...
            jQuery.ajax({
               ...
               // url: <?php echo base_url()?>+'admin/cityMapping/zole_list_display', 
                url: BASE_URL+'admin/cityMapping/zone_list_display',
