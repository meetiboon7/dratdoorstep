		...
		<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit E-Pharmacy Appointment</h5>
									<!--end::Page Title-->
								</div>
								<!--end::Info-->
							</div>
			...
			<div class="container">
				...
				<div class="card card-custom">
					<div class="card-body p-0">
						<form id="add_pharmacy_employee_form" class="form" action="<?php echo base_url(); ?>updatePharmacyAppointment" id="add_pharmacy_appointment_form" method="post" enctype="multipart/form-data">
							    ...
							    <input type="hidden" name="book_medicine_id" id="book_medicine_id" value="<?php echo $appointment_book['book_medicine_id'];?>">
							     <input type="hidden" name="user_id" id="user_id" value="<?php echo $appointment_book['user_id'];?>">
							    <div class="row">
							    		<div class="form-group col-md-6">
											<label><b>Contact Name *</b></label>
											<input type="text" class="form-control" placeholder="Enter Name" name="name" id="name" value="<?php echo $appointment_book['name'];?>" />
							    ...
							    <div class="row">
							    	<div class="form-group col-md-3">
											...
											<input type="text" class="form-control" placeholder="Enter Number" name="mobile" id="mobile" onkeypress="return isNumber(event)"  maxlength="10"  value="<?php echo $appointment_book['mobile'];?>"/>
											<div id="mobile_valid" class="validation" style="display:none;color:red;">Please Enter Value</div>
										</div>
										
										<div class="form-group col-md-3">
											<label><b>Landline </b></label>
											<input type="text" class="form-control" placeholder="Enter Number" name="landline" id="landline" onkeypress="return isNumber(event)"  maxlength="15" value="<?php echo $appointment_book['landline'];?>"/>
							     ...
							     <div class="row">
										...
										<div class="form-group col-md-6">
											...
											<textarea class="form-control" name="address" id="address"><?php echo $appointment_book['address'];?></textarea>
								 ...
								 <div class="row">
                                    <div class="form-group col-md-3">
                                     ...
                                     <div class="col-md-2 img1">
                                         <img src="<?php echo base_url().'uploads/pharmacy_document/'.$appointment_book['prescription'] ?>" width="100" height="100"/>
