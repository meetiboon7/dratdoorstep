			...
			<div class="container">
				...
				<div class="card card-custom">
					<div class="card-body p-0">
						<form id="add_ambulance_employee_form" class="form" action="<?php echo base_url(); ?>updateAmbulanceAppointment" id="add_ambulance_appointment_form" method="post" enctype="multipart/form-data">
                     ...
                     <div id="user_type_id" class="validation" style="display:none;color:red;">Please Enter Value</div>
							    ...
							    <div class="row">
							    	<div class="form-group col-md-3">
											...
											<input type="text" class="form-control" placeholder="Enter Number" name="mobile1" id="mobile1" onkeypress="return isNumber(event)"  maxlength="10" value="<?php echo  $appointment_book['mobile1'];?>" disabled />
											<div id="mobile1_valid" class="validation" style="display:none;color:red;">Please Enter Value</div>
										</div>
										
										<div class="form-group col-md-3">
											<label><b>Landline</b></label>
											<input type="text" class="form-control" placeholder="Enter Number" name="landline" id="landline" onkeypress="return isNumber(event)"  maxlength="15" value="<?php echo  $appointment_book['landline'];?>" disabled/>
                  ...
                  <div class="form-group col-md-6" >
                    ...
                    <input type="text" class="form-control" disabled placeholder="Fees" name="amount" id="amount" onkeypress="return isNumberKey(event)" value="<?php echo $appointment_book['amount'];?>"/>
