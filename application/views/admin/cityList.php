					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								<!--begin::Dashboard-->
								<?php
								if($all_permission[0][add_permission] == 1) {
								?>
										...
										<div class="card-body">
											<div class="form-group row">
												...
												<div class="col-lg-3">
													...
													<input type="text" class="form-control" required  name="city_code" placeholder="Enter City Code" id="city_code"/>
													<div id="city_code_valid" class="validation" style="display:none;color:red;">Please Enter Value</div>
												</div>
												<div class="col-lg-3">
														<label>Status </label>
								...
								<?php
									...
									if($all_permission[0][edit_permission] == 1) {
								?>
									...
									<form class="form" action="<?php echo base_url();?>updateCity" method="post">
										<div class="card-body">
											<div class="form-group row">
												...
												<div class="col-lg-3">
													<label>City Code*</label>
													<input type="text" class="form-control" name="city_code" value="" placeholder="Enter City Code" id="city_code_upt"/>
													<div id="city_code_valid_data" class="validation" style="display:none;color:red;">Please Enter Value</div>
												</div>
										...
										<!-- <table class="table table-separate table-head-custom table-checkable" id="kt_datatable"> -->
											...
											<thead>
												<tr>
													...
													<th>Status</th>
													<?php
													if($all_permission[0][edit_permission] == 1 || $all_permission[0][delete_permission] == 1) {
							...
							?>
											...
											<?php
														...
														if($all_permission[0][delete_permission] == 1) {
														?>
    ...
    $(function () {
        ...
        $("#btnSubmit").click(function () {
            ...
            if ($("#city_code").val()=='') {
                ...
                $('#city_code_valid').show();
        		
                return false;
            }
            else
            {
            	 $('#city_code_valid').hide();
            }
...
<script type="text/javascript">
    $(function () {
        ...
        $("#btnSubmitupt").click(function () {
            ...
            if ($("#city_code_upt").val()=='') {
                
                $('#city_code_valid_data').show();
        		
                return false;
            }
            else
            {
            	 $('#city_code_valid_data').hide();
            }
