...
<td colspan="2" style="text-align: left;" > <h2>Invoice No: <?php echo $app;?></h2></td>
            ...
            <tr class="information">
                <td colspan="2">
                    <table>
                        <tr>
                          <td>
                                <lable><b>Order Id: <?php echo $book_recipt['order_id'];?></b></lable><br>
                         <?php echo $book_recipt['name'];?><br>
                         <?php 
                         /*
                         if($address_data['from_address']=='' && $address_data['to_address']=='')
                         {
                            echo $extra_invoice['address'].$address_data['address_1']." ".$address_data['address_2']."<br>";
                         }
                         else
                         {
                            ?>
                            <lable><b>From Address:</b><?php echo $address_data['from_address'];?></lable><br>
                                  <lable><b>To Address:</b><?php echo $address_data['to_address'];?></lable><br>
                            <?php
                         }
                         */
                          //  echo $extra_invoice['address'].$address_data['address_1']." ".$address_data['address_2'];<br>
                         ?>
                                ...
                                <?php echo "Purchase Date :".date('d-m-Y',strtotime($book_recipt['purchase_date']));?>
                            </td>
            ...
            <tr class="item">
                <td>
                    <?php echo $book_recipt['package_name'];?> 
                </td>
                
                <td>
                   <?php echo $book_recipt['total'] ;?> Rs
                </td>
            </tr>
...
<tr class="item">
           ...
           <!--  <tr class="item">
            ...
            <tr class="total">
                ...
                <td>
                   Total: <?php echo $book_recipt['total'];?> Rs
                </td>
            </tr>
        </table>
<div class="row" style="font-size: 9px;
    ...
    <center>
  <!--   <a href="<?php echo base_url()."adminAllAppointment"?>" style="color: #3F4254;
