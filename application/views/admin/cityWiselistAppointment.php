													...
													?>
																		...
																		if($appointment['book_nurse_id']!='' && $appointment['responsestatus']!="TXN_FAILURE" && $appointment['responsestatus']!="TXN_CANCELLED" && $appointment['responsestatus']!="")
																		{
																			...
																			?>
																				<a href="#" style="pointer-events: none;
                    																cursor:not-allowed;background-color: #EEEEEE;" class="btn btn-sm btn-clean btn-icon mr-2 btn-assign" data-id="<?php echo $appointment['book_nurse_id'];?>,<?php echo "2";?>" title="Assign">
															...
															<span class="svg-icon svg-icon-md">
																...
																if($assing_appointment_id['appointment_id']==$appointment['book_laboratory_test_id']){
																			...
																			?>
																				<a href="#" style="pointer-events: none;
                    cursor:not-allowed;background-color: #EEEEEE;" class="btn btn-sm btn-clean btn-icon mr-2 btn-assign" data-id="<?php echo $appointment['book_laboratory_test_id'];?>,<?php echo "3";?>" title="Assign">
															...
															<span class="svg-icon svg-icon-md">
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">	
																		...
																		{
																			?>
																				<a href="#" class="btn btn-sm btn-clean btn-icon mr-2 btn-assign" data-id="<?php echo $appointment['book_ambulance_id'];?>" title="Assign">
