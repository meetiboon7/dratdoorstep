...
class NurseReport extends GeneralController {
	...
	{	
		 ...
		 $this->load->view('admin/nurseReport', $data);
		 $this->load->view(FOOTER);

		
	}
	public function generateNurseReport(){
		...
		$this->excel->getActiveSheet()->setCellValue('G1', 'Credit');
         ...
         $this->db->select('book_nurse.txndate,member.name,nurse_service_type.nurse_service_name,book_nurse.total,book_nurse.discount,book_nurse.voucher,book_nurse.credit');
	  ...
	  //       }
		...
		else
		{
			...
			$exceldata[]= "no matching records found";
                ...
                $filename='Nurse'; //save our workbook as this file name
