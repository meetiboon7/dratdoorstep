...
class CityWiseAppointmentList extends GeneralController {
	...
	public function index()
	{
		...
		elseif($this->session->userdata('admin_user')['user_type_id']==5)
		{
   		...
   		{
   				$this->db->select('appointment_book.*,member.contact_no,member.name,member.address,add_address.address_1,add_address.address_2');
				$this->db->from('appointment_book');
		...
		$this->load->view('admin/cityWiseAppointmentList',$data);
		$this->load->view(FOOTER);
	}
	public function citywiseAllAppointment()
	{
		extract($_POST);
  ...
  //       }
   ...
   //      	$this->db->select('book_ambulance.*');
       ...
       // $this->load->view('admin/todayAppointment',$data);
		$this->load->view('admin/cityWiselistAppointment',$data);
