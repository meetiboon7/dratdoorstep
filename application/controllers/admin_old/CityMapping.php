...
class CityMapping extends GeneralController {
	...
	public function insertCityMapping(){
		...
		if (!empty($post)) {
			...
			$this->session->set_flashdata('message','Manage City Mapping added successfully.');
	...
	public function updateCityMapping(){
		...
		if (!empty($post)) {
			...
			$this->session->set_flashdata('message','Manage City Mapping Information updated successfully.');
    ...
    public function zole_list_display($city_id="")
    {
