...
class Share extends REST_Controller
{
     ...
     * @OA\Get(
     *     path="/Share/get",
     *     tags={"Refer to Friend"},
     *     operationId="getRefer",
     *     summary="get Refer",
     *     description="",
     *     security={{"dads_auth":{}}},
     *     @OA\Response(
     ...
     * )
     */
    public function share_api_get_ci_get()
    {
            ...
            if(count($bearer))
            {
                try
                {
                    ...
                    $this->db->select('user.*');
                     ...
                     $this->db->where('user.user_id', $jwtUserData->user_id);
                    $users_Details = $this->db->get()->result_array();
                    ...
                    if (count($users_Details) > 0) {
                        ...
                        $apiResponse->message = "Share information received successfully";
                        $apiResponse->data['shareContent'] ="I'm inviting you to join DratDoorstep - an innovative health care solution, app by Nisarg wellness private limited.Here's my referral code - '".$users_Details[0]['referral_code']."' https://tinyurl.com/bmamdv2w";
                    ...
                    else
                    {
                        ...
                        $apiResponse = new Api_Response();
                        $apiResponse->status = true;
                        $apiResponse->message = "Share information not received successfully";
