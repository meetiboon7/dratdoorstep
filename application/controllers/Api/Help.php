...
class Help extends REST_Controller
{
     ...
     * )
     */
    public function help_api_ci_get()
    {
        ...
        if (isset($auth)) {
            ...
            if(count($bearer))
            {
                try
                {
                    ...
                    $help_Details = $this->db->get()->result_array();
                    ...
                    if (count($help_Details) > 0) {
                        ...
                        $apiResponse->message = "Help Details received successfully";
                        $apiResponse->data['text'] =  $help_Details[0][text];
                    ...
                    else
                    {
                        $apiResponse = new Api_Response();
                        $apiResponse->status = true;
                        $apiResponse->message = "Help Details not received";
