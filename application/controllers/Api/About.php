...
class About extends REST_Controller
{
     ...
     * )
     */
    public function about_api_ci_get()
    {
            ...
            if(count($bearer))
            {
                try
                {
                    ...
                    if (count($about) > 0) {
                        ...
                        $apiResponse->message = "About received successfully";
                        $apiResponse->data['about'] =  $about[0][html];
                       // $apiResponse->data[]['html'] =  $about[0][html];
                    ...
                    else
                    {
                        $apiResponse = new Api_Response();
                        $apiResponse->status = true;
                        $apiResponse->message = "About Details not received";
                       // $apiResponse->data['termscondition'] = $terms_Details;
                        $this->response($apiResponse, REST_Controller::HTTP_OK);
                    }
