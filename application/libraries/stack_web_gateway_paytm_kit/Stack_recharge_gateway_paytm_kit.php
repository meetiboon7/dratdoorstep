...
class Stack_recharge_gateway_paytm_kit{
	...
	public function __construct($config = array())
	{
		...
		*/
		...
		if (PAYTM_ENVIRONMENT == 'PROD') {
			...
			//===================================================
			$PAYTM_STATUS_QUERY_NEW_URL='https://securegw.paytm.in/oltp/HANDLER_INTERNAL/TXNSTATUS';
			...
			$PAYTM_STATUS_QUERY_NEW_URL='https://securegw-stage.paytm.in/oltp/HANDLER_INTERNAL/TXNSTATUS';
...
// 		$PAYTM_MERCHANT_MID 		= "qRYCBq85275861250220";
// 		$PAYTM_MERCHANT_KEY 		= "1&&zBjfJAu5FKXfT";
//     	$PAYTM_CHANNEL_ID 		= "WEB";
//         $PAYTM_INDUSTRY_TYPE_ID = "Retail";
// 		$PAYTM_MERCHANT_WEBSITE = "WEBSTAGING";
		
// 		Test Merchant ID
// qRYCBq85275861250220
// Test Merchant Key
// 1&&zBjfJAu5FKXfT
// Website
// WEBSTAGING
...
// WAP
		...
		$PAYTM_CALLBACK_URL 	= base_url()."successRechargePayment";
